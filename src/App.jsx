...
// - Logout
//
// React Router se utiliza para proteger el dashboard.
// La autenticación es pedagógica y no segura para producción.
...
function Dashboard() {
  ...
  // Todos los contactos obtenidos desde la API
  ...
  // Texto utilizado para buscar contactos
  ...
  // Función logout obtenida desde AuthContext
  ...
  const onActualizarContacto = async (contactoActualizado) => {
    try {
      ...
      // Actualizamos el contacto en la API
      const actualizado = await actualizarContacto(
        contactoActualizado.id,
        contactoActualizado
      );

      // Actualizamos el contacto dentro del estado
      setContactos((prev) =>
        prev.map((c) =>
  ...
  const onEliminarContacto = async (id) => {
    try {
      ...
      // Eliminamos el contacto del estado
      setContactos((prev) =>
        prev.filter((c) => c.id !== id)
      );

      // Si estaba editando ese contacto,
  ...
  // ==========================================
  // CAMBIAR A VISTA CONTACTOS
  // ==========================================

  const irAVerContactos = () => {
    setVista("contactos");

    // Limpiamos cualquier edición previa
    setContactoEnEdicion(null);
  };
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white text-xs md:text-sm font-semibold px-4 py-2 rounded-xl transition shadow-md"
            >
              Cerrar sesión
            </button>
          ...
          <aside className="space-y-4 md:space-y-5">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-purple-600 to-purple-800 text-white p-6 shadow-xl flex flex-col justify-between min-h-[220px]">
              ...
              <div className="mt-6 space-y-3 text-sm">
                ...
                <p className="text-[11px] text-purple-100/80 pt-2 border-t border-purple-500/30">

                  Proyecto desarrollado como evidencia
                  de mi aprendizaje en Desarrollo Web –
                  ReactJS.
            ...
            <div className="rounded-2xl bg-slate-900 border border-slate-700 p-4 text-slate-100 shadow-sm">
              ...
              <p className="text-xs text-slate-400 mt-3">
                ...
                "Estoy aprendiendo paso a paso para convertirme
                en un desarrollador capaz de crear soluciones
